...
Identity Evidence:
: Evidence which unambiguously identifies an Attesting Environment entity.
...
: a set of Trustworthiness Claims assigned during a single appraisal procedure by a Verifier using Evidence generated by an Attester.
